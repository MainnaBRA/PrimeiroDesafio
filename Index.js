...
console.log("Olá aventureiro! Bem vindo ao mundo da superação!")
console.log("Digite seu nome para começar sua aventura")
let nickname = " Mestre Yoda"
console.log("Bem vindo, " + nickname + "! Sua jornada começa agora.")
